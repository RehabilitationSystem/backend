...
//        String threadName = thread.getName();
        String threadName = Long.toString(thread.getId());
        //初始化计数器
    ...
    @Around("@annotation(com.example.commons.annotation.SonTransaction)")
    public void sonIntercept(ProceedingJoinPoint joinPoint) throws Throwable {
        Object[] args = joinPoint.getArgs();
//        Thread thread = (Thread) args[args.length - 1];
//        String threadName = thread.getName();
        Long threadId=(Long)args[args.length - 1];
        String threadName = threadId.toString();
